...
from rhino.nn.baked.gan.stylegan.stylegan1_modules import EqualLinearActModule
from .stylegan3_modules import MappingNetwork
...
class ADAStyleGAN2Discriminator(StyleGAN2Discriminator):
    ...
    def __init__(self, in_size, *args, data_aug=None, **kwargs):
        ...
        if self.with_ada:
            _class_name = data_aug.pop('type')   # Bypass the build
            self.ada_aug = ADAAug(**data_aug)
