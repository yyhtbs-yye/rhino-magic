...
class SwinViT2D(nn.Module):
    """
    Swin Vision Transformer backbone using RTSB stages on 2D image data.
    ...
    def __init__(self,
        ...
        # build residual swin‐style stages
