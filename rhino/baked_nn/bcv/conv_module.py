...
from .helpers import (_BatchNorm, _InstanceNorm, 
                          build_padding_layer, build_conv_layer, build_activation_layer, build_norm_layer)
...
class ConvModule(nn.Module):
    ...
    def init_weights(self):
        ...
        if not hasattr(self.conv, 'init_weights'):
            ...
            if self.with_bias and self.conv.bias is not None:
