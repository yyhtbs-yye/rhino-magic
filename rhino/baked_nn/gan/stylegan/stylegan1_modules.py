...
from rhino.baked_nn.bcv.fused_bias_leakyrelu import fused_bias_leakyrelu
from rhino.baked_nn.bcv.upfirdn2d import upfirdn2d
from rhino.baked_nn.gan.pggan.pggan_modules import (EqualizedLRConvModule, EqualizedLRConvUpModule, EqualizedLRLinearModule)
from rhino.baked_nn.bcv.helpers import build_activation_layer
...
class ConstantInput(nn.Module):
    ...
    def __init__(self, channel, size=4):
        ...
        if isinstance(size, int):
            ...
            assert len(size) == 2, f'The length of size should be 1 or 2 but got {len(size)}'
