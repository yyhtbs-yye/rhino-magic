...
from rhino.baked_nn.gan.pggan.pggan_modules import PixelNorm
from rhino.baked_nn.gan.stylegan.stylegan_utils import get_mean_latent, style_mixing, get_module_device

from .stylegan1_modules import ConstantInput, EqualLinearActModule
...
class StyleGAN2Generator(nn.Module):
    ...
    def __init__(self,
        ...
        if (self.cond_size is not None
            ...
            print('Mean latent code (w) is updated with EMA.')
    ...
    def get_mean_latent(self, num_samples=4096, **kwargs):
        ...
        if hasattr(self, 'w_avg'):
            print('Get latent code (w) which is updated by EMA.')
            return self.w_avg
